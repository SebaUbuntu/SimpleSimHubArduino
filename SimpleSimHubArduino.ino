...
#define DEVICE_NAME "Simple SimHub Arduino" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#define DEVICE_UNIQUE_ID "7b82ef68-6870-4f3b-8c28-59b4f19066f4" //{"UniqueId":"7b82ef68-6870-4f3b-8c28-59b4f19066f4","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
